...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        k = self.k.view(B, T, self.n_head, C // self.n_head).transpose(1, 2) # (B, nh, T, hs)
        q = self.q.view(B, T, self.n_head, C // self.n_head).transpose(1, 2) # (B, nh, T, hs)
        v = self.v.view(B, T, self.n_head, C // self.n_head).transpose(1, 2) # (B, nh, T, hs)
